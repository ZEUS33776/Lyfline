            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1">{(report.thal)}</p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-6">
            ...
            <div className="mt-8">
              ...
              <button onClick={() => setIsModalOpen(true)} className="flex items-center px-4 py-1 bg-blue-800 text-white rounded hover:bg-blue-600 transition-colors">
        <Plus className="w-4 h-4 mr-2" />
        Add New Report
      </button>
      {isModalOpen && (
        <PathologyReportForm pid={patient.patient_id} age={patient.age} sex={patient.male} fname={patient.first_name} lname={patient.last_name} 
          onClose={() => setIsModalOpen(false)}
          onSubmit={handleSubmit}
        />
      )}
              <h3 className="text-lg font-semibold mb-4 mt-3">Pathology Reports History</h3>
